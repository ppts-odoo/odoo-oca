        ...
        if acc_payment_ids:
            ...
            for line in acc_payment_ids:
                ...
                if payment_year == self.year:
                    ...
                    self.amount = amount
                    self.pdf_file = self.env['report'].with_context({'amount': amount,'year':self.year}).get_pdf([self.env.context.get('partner_id')], 'us_1099_form.report_1099').encode('base64')
