        ...
        if stock_obj.state!='done' and stock_obj.state!='cancel':
            ...
            for obj in stock_obj.move_lines:
                if obj.state != 'cancel'  and obj.state !='done':
                    ...
                    terms.append((0, 0, {'product_id':obj.product_id.id,'ref_id':obj.id,'product_qty':obj.product_qty,'product_uom':obj.product_uom.id,'drop_boolean' : False,'procurement_id':obj.procurement_id.id,'reff_line_id':obj.reff_line_id}))
