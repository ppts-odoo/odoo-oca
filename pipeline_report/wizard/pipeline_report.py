    ...
    def generate_xl_report(self):
        ...
        for user in user_ids:
            ...
            for stage in self.crm_stage_ids:
                ...
                sheet.write(n, 1, str(stage.name).upper() + ' [ Projects # ' + unicode(len(leads)) + ' ]', style01)
...
#                 i = 0;planned_revenue = 0;sale_amount_total = 0
                for lead in leads:
                    last_msg = ''
                    ...
                    sheet.write(n - 1, 2, lead.planned_revenue, new_style)
